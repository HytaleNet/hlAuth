...
public final class RegisterCommand extends AbstractPlayerCommand {

    private final AuthMePlugin plugin;
    private final RequiredArg<String> passwordArg;
    private final RequiredArg<String> confirmArg;

    public RegisterCommand(AuthMePlugin plugin) {
        super("register", "Register a new account");
        this.plugin = plugin;
        this.passwordArg = withRequiredArg("password", "Your new password", ArgTypes.STRING);
        this.confirmArg = withRequiredArg("confirmPassword", "Repeat the password", ArgTypes.STRING);
        addAliases("reg");
        requirePermission("hlauth.player.register");
